...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Yeni Yaşam Ağız ve Diş Sağlığı Polikliniği | Sultangazi" },
      {
        name: "description",
        content:
          "Sultangazi'de implant, gülüş tasarımı, zirkonyum ve ortodonti tedavileri. Dijital planlama ve ücretsiz ilk muayene.",
      },
      { name: "author", content: "Özel Yeni Yaşam Ağız ve Diş Sağlığı Polikliniği" },
      { property: "og:site_name", content: "Yeni Yaşam Klinik" },
      { property: "og:locale", content: "tr_TR" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#06264C" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", href: "/yeniyasam-favicon.png", type: "image/png", sizes: "512x512" },
      { rel: "shortcut icon", href: "/yeniyasam-favicon.png", type: "image/png" },
...
function RootComponent() {
  ...
  useEffect(() => {
    // First (initial load) page_view — config has send_page_view:false,
    // so the only page_view events come from trackPageView.
